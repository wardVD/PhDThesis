...
\textbf{10 GeV} &  & $73.2\pm7.7$ & $2.2\pm1.6$ & ${ 5.0\cdot 10^{{-16}} }^{ +2.9\cdot 10^{{-16}} }_{ -3.8\cdot 10^{{-16}} }$ & 0.32 \\ \cline{3-6} 
\textbf{100 GeV} &  & $121.3\pm12.6$ & $2.2\pm1.8$ & ${ 3.0\cdot 10^{{-16}} }^{ +2.8\cdot 10^{{-16}} }_{ -2.3\cdot 10^{{-16}} }$ & 0.33 \\ \cline{3-6}
\textbf{1 TeV} &  & $90.7\pm9.6$ & $0.8\pm0.6$ & ${ 1.9\cdot 10^{{-16}} }^{ +2.5\cdot 10^{{-16}} }_{ -1.8\cdot 10^{{-17}} }$ & 0.35 \\ \cline{3-6}
\textbf{10 TeV} &  & $127.8\pm11.0$ & $1.8\pm1.1$ & ${ 2.1\cdot 10^{{-16}} }^{ +1.4\cdot 10^{{-16}} }_{ -1.2\cdot 10^{{-16}} }$ & 0.34 \\ \cline{3-6}
\textbf{100 TeV} & \multirow{-5}{*}{1/2} & $107.7\pm9.7$ & $2.2\pm1.3$ & ${ 3.4\cdot 10^{{-16}} }^{ +1.9\cdot 10^{{-16}} }_{ -2.6\cdot 10^{{-16}} }$ & 0.34 \\ \hline
\textbf{10 GeV} &  & $45.3\pm5.2$ & $2.2\pm1.9$ & ${ 8.2\cdot 10^{{-16}} }^{ +7.7\cdot 10^{{-16}} }_{ -6.2\cdot 10^{{-16}} }$ & 0.32 \\ \cline{3-6}
...
\textbf{10 GeV} &  & $73.2 \pm 48.5$ & $2.2^{+3.5}_{-2.2}$ & 0 & ${5.0 \cdot 10^{-16}} ^{+4.15 \cdot 10^{-15}} _{-4.35 \cdot 10^{-16}}$ & $1.4 \cdot 10^{-16}$ \\ \cline{3-7}
\textbf{100 GeV} &  & $121.3 \pm 75.7$ & $2.2^{+4.4}_{-2.2}$ & 0 & ${3.0 \cdot 10^{-16}} ^{+2.45 \cdot 10^{-15}} _{-2.61 \cdot 10^{-16}}$ & $8.1 \cdot 10^{-17}$ \\ \cline{3-7}
\textbf{1 TeV} &  & $90.7 \pm 46.1$ & $0.8^{+1.3}_{-0.8}$ & 0 & ${1.9 \cdot 10^{-16}} ^{+1.14 \cdot 10^{-15}} _{-1.13 \cdot 10^{-16}}$ & $1.6 \cdot 10^{-16}$ \\ \cline{3-7}
\textbf{10 TeV} &  & $127.8 \pm 59.0$ & $1.8^{+3.0}_{-1.8}$ & 2 & ${2.1 \cdot 10^{-16}} ^{+1.24 \cdot 10^{-15}} _{-1.79 \cdot 10^{-16}}$ & $2.5 \cdot 10^{-16}$ \\ \cline{3-7}
