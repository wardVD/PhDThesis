...
Hit Statistics & ZTravel & \begin{tabular}[c]{@{}c@{}}ZTravel is the average difference of the z value of all hit DOMs\\ with the first (in time) quartile z value.\end{tabular} \\ \cline{2-3} 
...
\noindent The limited amount of statistics in the tail of the CORSIKA datasets prove challenging. There is a need for an order of magnitude, at least, for more events, which is not feasible with the available resources. Other techniques, such ass defining off-source or off-time regions \cite{•}, are not available for this search as we have assumed an isotropic flux that is not time-dependent.
...
\noindent The BDT score where the MRF is minimized is chosen as the final cut; this is the cut that will give the most stringent upper limit or best value for an observation. The results can be found in Tab. \ref{tab:expectedresults}.

\begin{table}[]
\centering
\renewcommand{\arraystretch}{1.5}
\caption{Expected amount signal and background events for 5 years of data (see Section \ref{subsec:unblinding}), errors are statistical only. The signal is normalized to a flux of $10^{-14} \textrm{cm}^{-2} \textrm{s}^{-1} \textrm{sr}^{-1}$ The optimal BDT cut value from the MRF minimization is shown together with the expected upper limit and the statistical error.}
...
10 GeV & 1/2 & $73.2\pm7.7$ & $2.2\pm1.6$ & ${ 5.0\cdot 10^{{-16}} }^{ +2.9\cdot 10^{{-16}} }_{ -3.8\cdot 10^{{-16}} }$ & 0.32 \\ \hline
100 GeV & 1/2 & $121.3\pm12.6$ & $2.2\pm1.8$ & ${ 3.0\cdot 10^{{-16}} }^{ +2.8\cdot 10^{{-16}} }_{ -2.3\cdot 10^{{-16}} }$ & 0.33 \\ \hline
1 TeV & 1/2 & $90.7\pm9.6$ & $0.8\pm0.6$ & ${ 1.9\cdot 10^{{-16}} }^{ +2.5\cdot 10^{{-16}} }_{ -1.8\cdot 10^{{-17}} }$ & 0.35 \\ \hline
10 TeV & 1/2 & $127.8\pm11.0$ & $1.8\pm1.1$ & ${ 2.1\cdot 10^{{-16}} }^{ +1.4\cdot 10^{{-16}} }_{ -1.2\cdot 10^{{-16}} }$ & 0.34 \\ \hline
100 TeV & 1/2 & $107.7\pm9.7$ & $2.2\pm1.3$ & ${ 3.4\cdot 10^{{-16}} }^{ +1.9\cdot 10^{{-16}} }_{ -2.6\cdot 10^{{-16}} }$ & 0.34 \\ \hline
10 GeV & 1/3 & $45.3\pm5.2$ & $2.2\pm1.9$ & ${ 8.2\cdot 10^{{-16}} }^{ +7.7\cdot 10^{{-16}} }_{ -6.2\cdot 10^{{-16}} }$ & 0.32 \\ \hline
...
\subsection{Limits}
\label{subsec:limits}
After unblinding, the number of data events for all signal points were consistent with the expected background, which can be seen in Tab. \ref{tab:finalresults}. The upper limits were computed with Eq. \ref{eq:finalUL}. Event views of the types of these events can be found in Appendix \ref{ch:eventviewerFinal}.


\begin{table}[]
\centering
\renewcommand{\arraystretch}{1.5}
\caption{Final results of the upper limit computations. Signal is the expected rate from a $10^{-14} \textrm{cm}^{-2} \textrm{s}^{-1} \textrm{sr}^{-1}$ and background and signal are normalized to the total livetime of the full dataset.}
...
10 GeV & 1/2 & $73.2 \pm 48.5$ & $2.2^{+3.5}_{-2.2}$ & 0 & ${5.0 \cdot 10^{-16}} ^{+4.15 \cdot 10^{-15}} _{-4.35 \cdot 10^{-16}}$ & $1.4 \cdot 10^{-16}$ \\ \hline
100 GeV & 1/2 & $121.3 \pm 75.7$ & $2.2^{+4.4}_{-2.2}$ & 0 & ${3.0 \cdot 10^{-16}} ^{+2.45 \cdot 10^{-15}} _{-2.61 \cdot 10^{-16}}$ & $8.1 \cdot 10^{-17}$ \\ \hline
1 TeV & 1/2 & $90.7 \pm 46.1$ & $0.8^{+1.3}_{-0.8}$ & 0 & ${1.9 \cdot 10^{-16}} ^{+1.14 \cdot 10^{-15}} _{-1.13 \cdot 10^{-16}}$ & $1.6 \cdot 10^{-16}$ \\ \hline
10 TeV & 1/2 & $127.8 \pm 59.0$ & $1.8^{+3.0}_{-1.8}$ & 2 & ${2.1 \cdot 10^{-16}} ^{+1.24 \cdot 10^{-15}} _{-1.79 \cdot 10^{-16}}$ & $2.5 \cdot 10^{-16}$ \\ \hline
