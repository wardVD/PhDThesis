...
\centering
%\begin{footnotesize}
\caption{Summary of the known forces and their properties. The relative strength is compared to the electromagnetic force, but also depends on the energy scale.}
...
\textbf{Rel. strength}                                              & $10^{-35}$                                            & $10^{-11}$                   & 1                                       & $10^2$ \\ \hline
...
\item Another example is the measurement of the \textit{Lambd shift}, a difference in energy between two energy levels of the hydrogen atom that was not predicted by the Dirac equation and currently provides a measurement of the fine-structure constant $\alpha$ to better than one part in a million, allowing a precision test of QED.
