...
\begin{table}[]
\centering
\caption{Observables compared with the SM best fit. Errors are the total (experimental plus theoretical) uncertainties. Results are taken from Tables 10.4 and 10.5 in Ref. \cite{PDG2018url}.}
\label{tab:precision}
\resizebox{\textwidth}{!}{%
