...
%\begin{scriptsize}
%\hline
%\multicolumn{1}{c}{\cellcolor{grey}} &       & \cellcolor[HTML]{FE0000}Weak                      & \cellcolor[HTML]{FE0000} Electromagnetic      & \multicolumn{2}{c|}{\cellcolor{grey}Strong}                            \\ \cline{3-6}
%\multirow{-2}{*}{\cellcolor{grey}\textbf{Interaction}}     &  \multirow{2}{*}{\cellcolor{grey}Gravitation} \cellcolor{grey} & \multicolumn{2}{c|}{\cellcolor[HTML]{FE0000}Electroweak}                                     & \cellcolor{grey}Fundamental    & \cellcolor{grey}Residual                   \\ \hline \hline
...
%ref: Notes on Dirac's lecture Developments in Atomic Theory at Le Palais de la Découverte, 6 December 1945. UKNATARCHI Dirac Papers. BW83/2/257889. 
...
The simplest GUT is SU(5), which would break down into the Standard Model at lower energies due to spontaneous symmetry breaking. Other possible extensions are SO(10)REF , SU(8)REF and O(16)REF Lie groups.
