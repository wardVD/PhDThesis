...
\chapter*{Introduction and Summary}\label{ch1}
...
%	CHAPTER 4
%----------------------------------------------------------------------------------------
\chapterimage{MuonWithPhotons.png}
...
\part{Simulation, Data Processing and Analysis}
...
%	CHAPTER 8
%----------------------------------------------------------------------------------------
\chapterimage{wallhaven-442918.jpg}
