...
\chapterimage{checks.jpg}
\chapter{Additional BDT checks}
\label{ch:bdtchecks}

\begin{figure}
\centering
\includegraphics[width=\textwidth]{appendix/img/overtrainingbackground.png}
\includegraphics[width=\textwidth]{appendix/img/overtrainingsignal.png}
\caption{Blub}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{appendix/img/correlation.png}
\caption{Blub}
