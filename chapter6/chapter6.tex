...
\vspace{2mm}
\begin{itemize}
\item \texttt{Polyplopia}: a project dedicated to merge multiple events to account for coincident events (that are simulated independently). An estimated 15\% of CORSIKA events result in coincident events and make up the bulk of bad reconstructions where downgoing muons are simulated as upgoing (example see Figure \ref{fig:coincidentevent});
